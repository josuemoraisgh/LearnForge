...
\begin{frame}
\frametitle{3) Um sensor RTD de platina tem resistência nominal 100 Ω a 0 °C. Sabendo que a resistência medida é 95 Ω e o coeficiente de temperatura é 0.00 1/°C, calcule a temperatura do sensor pela equação:
...
{\BodySize
\begin{itemize}
\item[a)] O valor correto é -12.51
\item[b)] O valor correto é -9.01
\item[c)] O valor correto é -16.01
\item[d)] O valor correto é -6.76
\item[e)] O valor correto é -13.51
\end{itemize}
}
\end{frame}
...
\item[c)] O valor correto é -16.01
\item[d)] O valor correto é -6.76
\item[e)] \alert{O valor correto é -13.51}
\end{itemize}
}
\end{frame}
